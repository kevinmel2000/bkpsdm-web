  module.controller('form-data', function($scope, $sce,$http,$timeout) {
    $scope.antri = function() {
     $http.get(base_url()+'Administrator/Transaksi/antri').success(function(data){
     $scope.myVal = data;
    });
    $timeout(function(){
           $scope.antri();
    ...
    $scope.cuci = function() {
     $http.get(base_url()+'Administrator/Transaksi/dicuci').success(function(data){
     $scope.myVal2 = data;
    });
    $timeout(function(){
           $scope.cuci();
    ...
    $scope.kering = function() {
     $http.get(base_url()+'Administrator/Transaksi/kering').success(function(data){
     $scope.myVal3 = data;
    });
    $timeout(function(){
           $scope.kering();
    ...
    $scope.bayar = function() {
     $http.get(base_url()+'Administrator/Transaksi/bayar').success(function(data){
     $scope.myVal4 = data;
    });
    $timeout(function(){
           $scope.bayar();
    ...
    $scope.selesai = function() {
     $http.get(base_url()+'Administrator/Transaksi/selesai').success(function(data){
     $scope.myVal5 = data;
    });
    $timeout(function(){
           $scope.selesai();
    ...
    $scope.my = {};
      $http({
        method: 'POST',
        url     : base_url()+'Administrator/Transaksi_Act/save_antri',
    ...
    $scope.my = {};
      $http({
        method: 'POST',
        url     : base_url()+'Administrator/Transaksi_Act/save_cuci',
    ...
    $scope.my = {};
      $http({
        method: 'POST',
        url     : base_url()+'Administrator/Transaksi_Act/save_bayar',
    ...
    $scope.my = {};
      $http({
        method: 'POST',
        url     : base_url()+'Administrator/Transaksi_Act/save_kering',
