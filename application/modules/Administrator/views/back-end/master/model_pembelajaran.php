...
<div class="row"> 
  ...
  enctype="multipart/form-data" action="<?=site_url('Administrator/Master_Act/model_pembelajaran/'.$cAction.'')?>">
	    ...
	    <div class="row">
	     ...
	     <!-- <div class="col-sm-6 ol-xs-12">
	      ...
	      <div class="form-group">
 			...
 			<input type="hidden" name="dTgl" id="dTgl" class="form-control 4IDE-Date" 
	     ...
	     <div class="col-sm-4 ol-xs-12">
	      ...
	      <div class="form-group">
 			...
 			<input type="hidden" name="cJam" id="cJam" class="form-control 4IDe-Time" 
  ...
  function EditData(id){
		...
		window.location.href='<?=base_url()?>Administrator/Master/model_pembelajaran/edit/'+id; 
		...
		bootbox.confirm("Apakah Yakin Hapus Data ?", function(result) {
	          ...
	          if(result) {
	            ...
	            $.ajax({
	                ...
	                url: "<?=site_url('Administrator/Master_Act/model_pembelajaran/hapus')?>/"+id,
	                ...
	                success:function(msg){
	                  ...
	                  setTimeout(function() { window.location = '<?=base_url()?>Administrator/Master/model_pembelajaran' },2000);
