	    ...
	    <div class="row">
	     <div class="col-sm-12 col-xs-12">
	      <div class="form-group">
 			...
 			<select name="cIdKategori" id="cIdKategori" class="form-control 4IDE-Combobox">
 				...
 				foreach ($service as $key => $vaService) {
 					# code...
 				?>
	     ...
	     <div class="col-sm-12 col-xs-12">
	      <div class="form-group">
 			...
 			<input type="text" name="cNama" id="cNama" placeholder="Nama Layanan" class="form-control" value="<?=$cNama?>">
...
<!--	     <div class="col-sm-6 col-xs-6">
   ...
   <div class="widget-box widget-color-green3">
	...
	<div class="widget-body">
	  <div class="widget-main">
	   	<p>Form Service Adalah List Service Anda Yang Akan Ditampilkan Di Halaman Web Front End</p>
	   	<hr/>
	   	2017 © 	
	   </div>
	 </div>
 ...
 <script type="text/javascript">
	...
	function EditData(id){
		window.location.href='<?=base_url()?>Administrator/Master/service/edit/'+id; 
	}
	          ...
	          if(result) {
	            $.ajax({
	                ...
	                success:function(msg){
	                  ...
	                  setTimeout(function() { window.location = '<?=base_url()?>Administrator/Master/service' },2000);
	                }
	            });
	          }
	        });	
