    ...
    <section class="sidebar" id="sidebar-scroll">
     <!--  <div class="user-panel">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="<?=base_url()?>Front/Halaman"><i class="icon-home"></i><span>  Home </span></a></li>
        <li><a href="<?=base_url()?>Front/Halaman/profil"><i class="icon-like"></i><span>  Profil </span></a></li>
        <li><a href="<?=base_url()?>Front/Halaman/berita"><i class="icon-globe"></i><span>  Berita </span></a></li>
        <?php 
          if($this->session->userdata('isLogin') == "True"){
        ?>
        <li><a href="<?=base_url()?>Front/Halaman/pembelajaran"><i class="icon-layers"></i><span>  Modul Pembelajaran </span></a></li>
        <li><a href="<?=base_url()?>Front/Halaman/modelpemebelajaran"><i class="icon-layers"></i><span>  Modul Model Pembelajaran</span></a></li>
        <?php } ?>
        <?php 
          if($this->session->userdata('isLogin') == ""){
        ?>
            <li><a href="<?=base_url()?>Front/Halaman/login"><i class="icon-login"></i><span>  Login </span></a></li>
        <?php } else { ?>
            <li><a href="<?=base_url()?>Front/Halaman_Act/logout"><i class="icon-logout"></i><span>  <?=$this->session->userdata('nama')?> , Logout </span></a></li>
        <?php } ?>
      </ul>
