...
<div class="row"> 
  ...
  enctype="multipart/form-data" action="<?=site_url('Member/Master_Act/pembelajaran/'.$cAction.'')?>">
  ...
  function EditData(id){
		...
		window.location.href='<?=base_url()?>Member/Master/pembelajaran/edit/'+id; 
		...
		bootbox.confirm("Apakah Yakin Hapus Data ?", function(result) {
	          ...
	          if(result) {
	            ...
	            $.ajax({
	                ...
	                url: "<?=site_url('Member/Master_Act/pembelajaran/hapus')?>/"+id,
	                ...
	                success:function(msg){
	                  ...
	                  setTimeout(function() { window.location = '<?=base_url()?>Member/Master/pembelajaran' },2000);
