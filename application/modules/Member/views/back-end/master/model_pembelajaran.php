<?php 
	...
	if($action == 'edit') {
		 ...
		 foreach ($field as $column) {
		 	...
		 	$cLinkYoutube 			=	$column['link_youtube'];
...
<div class="row"> 
  ...
  enctype="multipart/form-data" action="<?=site_url('Member/Master_Act/model_pembelajaran/'.$cAction.'')?>">

  <input type="hidden" name="cLink" value="model_pembelajaran">
	     ...
	     <!-- <div class="col-sm-6 ol-xs-12">
	      ...
	      <div class="form-group">
 			...
 			<input type="hidden" name="dTgl"  class="form-control 4IDE-Date" 
 			 ...
 			 value="<?=$dTgl?>" data-date-format="DD-MM-YYYY">

	     <!--  </div>

	     </div>

	     <div class="col-sm-4 ol-xs-12">
	    ...
	    <?php 
	     ...
	     <div class="col-sm-12 col-xs-12">
	      ...
	      <div class="form-group">
 			...
 			<input type="text" name="cLinkYoutube" id="cLinkYoutube" class="form-control" 

 			placeholder="Link Youtube" value="<?=$cLinkYoutube?>">
  ...
  function EditData(id){
		...
		window.location.href='<?=base_url()?>Member/Master/model_pembelajaran/edit/'+id; 
		...
		bootbox.confirm("Apakah Yakin Hapus Data ?", function(result) {
	          ...
	          if(result) {
	            ...
	            $.ajax({
	                ...
	                url: "<?=site_url('Member/Master_Act/model_pembelajaran/hapus')?>/"+id,
	                ...
	                success:function(msg){
	                  ...
	                  setTimeout(function() { window.location = '<?=base_url()?>Member/Master/model_pembelajaran' },2000);
