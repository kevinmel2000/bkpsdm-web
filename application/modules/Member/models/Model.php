...
class Model extends CI_Model {
	...
	public function ViewWhereWhereASC($Table,$WhereField1,$WhereValue1,$WhereField2,$WhereValue2,$Order) {

		$Query = $this->db->query("SELECT * FROM ".$Table." WHERE ".$WhereField1." = '".$WhereValue1."' AND ".$WhereField2." = '".$WhereValue2."'  ORDER BY ".$Order." ASC ");
